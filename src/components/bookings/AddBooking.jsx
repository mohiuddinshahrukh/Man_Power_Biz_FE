        ...
        validate: {
            ...
            bookingZip: (value) =>
                (value.trim()).length > 0
                    ? null
                    : "Select A ZIP",
            bookingCustomer: (value) => (value.trim()).length > 0 ? null : "Select A Customer",
            bookingService: (value) => (value.trim()).length > 0 ? null : "Select A Service",
            bookingPackage: (value) => (value.trim()).length > 0 ? null : "Select A Package",
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <form
                                    onSubmit={generalBookingDetailsForm.onSubmit((values) => generalBookingDetailsFunction(values))}
                                >
                                    <Grid justify="space-around" py="md">
                                        ...
                                        <Grid.Col lg={6}>
                                            <Select
                                                ...
                                                rightSection={<ChevronDown size={14} />}
                                                rightSectionWidth={40}
                                                {...generalBookingDetailsForm.getInputProps("bookingCustomer")}
                                            />
                                        </Grid.Col>
                                        <Grid.Col lg={6}>
                                            <Select
                                                ...
                                                rightSection={<ChevronDown size={14} />}
                                                rightSectionWidth={40}
                                                {...generalBookingDetailsForm.getInputProps("bookingService")}
                                            />
                                        </Grid.Col>
                                        ...
                                        <Grid.Col lg={6}>
                                            <Select
                                                ...
                                                searchable
                                                data={packagesList}
                                                {...generalBookingDetailsForm.getInputProps("bookingPackage")}
                                            />
                                        </Grid.Col>
                                        <Grid.Col lg={6}>
                                            <DateInput size="md"
                                                ...
                                                {...generalBookingDetailsForm.getInputProps("bookingDate")}
                                            />
                        ...
                        >
                            <Paper py="xl">
                                <form
                                    onSubmit={contactInformationForm.onSubmit((values) => contactInformationFunction(values))}
                                >
                                    ...
                                    <Grid>
                                        ...
                                        <Grid.Col md={12} lg={6}>
                                            ...
                                            <TextInput
                                                ...
                                                {...contactInformationForm.getInputProps("bookingContactNumber")}
                                            />
                                        </Grid.Col>
                                        <Grid.Col md={12} lg={6}>
                                            <TextInput
                                                ...
                                                required
                                                label="Email Address"
                                                {...contactInformationForm.getInputProps("bookingEmailAddress")}
                                            />
                                        </Grid.Col>
