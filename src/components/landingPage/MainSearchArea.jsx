import { BackgroundImage, Button, Center, Chip, Group, Select, Stack, TextInput, Title } from "@mantine/core"
                ...
                <Stack align="center">
                    ...
                    <Group position="center" align="start">
                        <Select
                            ...
                            }} label="City" placeholder="Select a city" data={[{ value: "kolkata", label: "Kolkata" }]}></Select>
                        <Select styles={{
                            label: {
                                color: "white"
                            }
                        }} label="Pin" placeholder="Select a pin" data={[
                        ...
                        <Stack spacing={3} >
                            <TextInput rightSectionWidth={"100px"} rightSection={<Button rightIcon={<IconSearch />} >{"Search"}</Button>} styles={{
                                label: {
                                    color: "white"
                                }
                            }} label="Search"
                            ...
                            <Group spacing={3}>
                                {[{
                                    value: "mens hair salons", label: "Mens Hair Salons"
                                }, {
                                    value: "womens hair salons", label: "Womens Hair Salons"
                                }, {
                                    value: "electrician", label: "Electricians"
                                }, {
                                    value: "house painters", label: "House Painters"
                                },
                                ].map((data, index) => {
