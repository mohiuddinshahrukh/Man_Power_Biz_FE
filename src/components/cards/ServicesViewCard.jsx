...
import { IconLocation, IconMap, IconMap2, IconMapPin, IconPin, IconPinned } from "@tabler/icons-react"
            ...
            <Grid>
                <Grid.Col>
                    <Group position="apart">
                        ...
                        <Badge variant="filled" color={data.serviceStatus === true ? "green" : "red"}>{data.serviceStatus === true ? "Active" : "Blocked"}</Badge>
                    </Group>
