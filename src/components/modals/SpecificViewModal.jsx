...
const SpecificViewModal = ({ opened, close, title, open, data }
    ...
    return (
        <Modal
            ...
            {pathname.includes("categories") ? <ServiceCategoryViewCard data={data} /> : pathname.includes("service") ? < ServicesViewCard data={data} /> : pathname.includes("viewPackages") ? <PackageViewCard data={data} /> : pathname.includes("viewBookings") ? <InvoiceViewCard data={data} /> : null}
